package com.jike.moba.service.ws;

import cn.hutool.core.date.DateUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.google.gson.Gson;
import com.jike.moba.config.HttpSessionConfigurator;
...
import com.jike.moba.model.request.MessageRequest;
...
public class WebSocket {
    ...
    private void savaChat(Long userId, Long toId, String text, Long teamId, Integer chatType) {
        if (chatType == ChatConstant.PRIVATE_CHAT) {
            ...
            Set<Long> userIds = com.jike.moba.utils.StringUtils.stringJsonListToLongSet(user.getUserIds());
