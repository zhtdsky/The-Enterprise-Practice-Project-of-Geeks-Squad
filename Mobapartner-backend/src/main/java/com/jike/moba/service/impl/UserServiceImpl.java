...
import com.jike.moba.mapper.UserMapper;
import com.qimu.jujiao.model.entity.User;
import com.jike.moba.model.request.UpdateTagRequest;
import com.jike.moba.model.request.UserQueryRequest;
import com.jike.moba.model.request.UserUpdatePassword;
...
import static com.jike.moba.contant.UserConstant.ADMIN_ROLE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public String redisFormat(Long key) {
        return String.format("MobaPartner:user:search:%s", key);
    }
    ...
    public List<User> getFriendsById(User currentUser) {
        ...
        Set<Long> friendsId = com.jike.moba.utils.StringUtils.stringJsonListToLongSet(loginUser.getUserIds());
    ...
    public boolean deleteFriend(User currentUser, Long id) {
        ...
        Set<Long> friendsId = com.jike.moba.utils.StringUtils.stringJsonListToLongSet(loginUser.getUserIds());
        Set<Long> fid = com.jike.moba.utils.StringUtils.stringJsonListToLongSet(friendUser.getUserIds());
        friendsId.remove(id);
    ...
    public List<User> searchFriend(UserQueryRequest userQueryRequest, User currentUser) {
        ...
        Set<Long> friendsId = com.jike.moba.utils.StringUtils.stringJsonListToLongSet(user.getUserIds());
